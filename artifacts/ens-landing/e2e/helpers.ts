...
const CHIEF_EMAIL = process.env.TEST_CHIEF_EMAIL ?? "owner@ens.test";
const CHIEF_PASSWORD = process.env.TEST_CHIEF_PASSWORD ?? "EnsDev2026!";
const PM_EMAIL = process.env.TEST_PM_EMAIL ?? "pm@ens.test";
const PM_PASSWORD = process.env.TEST_PM_PASSWORD ?? "EnsDev2026!";
const CLIENT_EMAIL = process.env.TEST_CLIENT_EMAIL ?? "client@ens.test";
